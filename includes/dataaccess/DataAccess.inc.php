...
abstract class DataAccess{
	...
	*/
	...
	/**
	* Subclasses should invoke this method if an error occurs while executing a query (or when other things go wrong).
	...
	* to the proper names. For example: $user->id is converted to $row['user_id']
